...
exports.order = function (req, res) {
    ...
    if (req.query.order_payment_method === 'credit_card')
    {
	    ...
	    paypalPayment.redirect_urls.return_url = "http://" + config.host + ":" + (config.port ? config.port : 3000) + "/orderExecute?order_id=" + order_id;
	    paypalPayment.redirect_urls.cancel_url = "http://" + config.host + ":" + (config.port ? config.port : 3000) + "/?status=cancel&order_id=" + order_id;
